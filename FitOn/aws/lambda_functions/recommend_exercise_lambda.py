...
def help():
    ...
    columns = "Sleep Duration, Physical Activity Level, Heart Rate, Daily Steps, Gender_Female, Gender_Male, BMI Category_Normal, BMI Category_Normal Weight, BMI Category_Obese, BMI Category_Overweight, Sleep Disorder_Insomnia, Sleep Disorder_Sleep Apnea \n"
    example = "example : '7.2,60,68,7000,True,False,True,False,False,False,False,False\n24,7.8,64,68,732,True,False,True,False,False,False,False,False)' "
