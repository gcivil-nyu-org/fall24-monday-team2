...
class PasswordResetTests(TestCase):
    ...
    def test_missing_email_on_reset_request(self):
        ...
        self.assertContains(response, 'This field is required.', html=True, status_code=200)
    ...
    def test_successful_password_reset_flow(self):
        ...
        login_response = self.client.post(reverse('login'), {'username': self.user.username, 'password': 'newpassword123'})
